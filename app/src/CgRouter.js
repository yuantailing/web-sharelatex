...
module.exports = {
  apply(webRouter) {
    webRouter.get('/githubcallback', function(req, res, next) {
            ...
            return async.mapSeries(
              ...
              function(err, users) {
                ...
                return res.json(
                  users
                    .filter(u => u != null)
                    .map(UserInfoController.formatPersonalInfo)
                )
              }
            )
          })
    ...
    webRouter.post(
      ...
      function(req, res, next) {
        ...
        logger.log(
          { project_id, on, on_for, on_for_guests },
        ...
        if (on === true) {
          ...
          s = {}
          if (on_for_guests === true) s['__guests__'] = true
          for (user_id in on_for)
            if (
              typeof user_id === 'string' &&
              typeof on_for[user_id] === 'boolean'
            )
    ...
    webRouter.post(
      ...
      function(req, res, next) {
        ...
        logger.log(
          ...
          'CG:POST:project/thread/messages/edit'
        )
    ...
    webRouter.delete(
      ...
      function(req, res, next) {
        ...
        logger.log(
          { project_id, thread_id, message_id },
          'CG:DELETE:project/thread/messages'
        )
